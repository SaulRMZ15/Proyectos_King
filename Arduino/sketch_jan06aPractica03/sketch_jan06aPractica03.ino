...
void setup() {
  ...
  // Imprimimos la IP address que utilizara el server
...
void loop() {
  ...
  // Espera al que el cliente mande mas datos
  ...
  client.flush();
  // coincidimos la solicitud del cliente
  int value = LOW;
  ...
  //Establecer ledPin según la solicitud
