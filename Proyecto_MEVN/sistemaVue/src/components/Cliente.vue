    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar color="white">
                <v-toolbar-title class="purple--text">Clientes</v-toolbar-title>
                <v-divider
                class="mx-2"
                inset
                vertical
            ...
            <v-data-table :headers="headers" :items="personas" :search="search"  class="elevation-1">
                ...
                <template v-slot:no-data>
                    <v-btn color="white" @click="listar()">Resetear</v-btn>
                </template>
            </v-data-table>
        </v-flex>
    </v-layout>
        ...
        methods: {
            ...
            validar(){
                ...
                if(this.nombre.length>50){
                    this.validaMensaje.push('El correo del cliente no debe ser más de 50 caracteres.');
                }
