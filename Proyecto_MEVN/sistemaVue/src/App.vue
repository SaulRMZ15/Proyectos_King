    ...
    >
      ...
      >
        <v-app-bar-nav-icon
         ...
         v-show="logueado"
         ></v-app-bar-nav-icon>
        <span class="hidden-sm-and-down, white--text">Maniacorp</span>
      </v-toolbar-title>      
      <v-spacer></v-spacer>
      <v-btn icon color="white" @click="salir()" v-show="logueado">
        <v-icon>logout</v-icon>  
      </v-btn>
      <v-btn :to="{name: 'login'}" icon v-if="!logueado">
        <v-icon>login</v-icon>  
      </v-btn>
       <v-btn icon color="white"  :to="{name: 'registrar'}" v-show="!logueado" >
